...
#list of cars
bil1 = ['Ford focus', 'årsmodell 1982', '28 000 km.']
bil2 = ['Nissan micra', 'årsmodell 1992', '23 000 km.']
bil3 = ['Scoda octavia', 'årsmodell 1990', '38 000 km.']
bil4 = ['Volvo 850', 'årsmodell 1995', '2 000 km.']
billista = ["Ford focus", "Nissan micra", "Scoda Octavia", "Volvo 850"]
...
#function for calculating price of service
def ServiceCost():
    service = 1500+500
    print("Kostnaden för service är " + str(service) + "kr.") 
...
try: 
    ...
    while True:
        ...
        print("Välkommen till Bilförsäljning AB! ")
        print("Vad vill du göra?: ")
        print("***************************")
        print("1.Registrera köpare")
        print("2.Se innevarande bilar")
        print("3.Hantera service, reparation och garantiärenden")
        print("4.Hantera personal\n")
        ...
        if x == 1:
            ...
            while True:
                ...
                print("*******************************************")
                print("För att räkna ut pris för service    - skriv SER")
